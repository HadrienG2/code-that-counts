...
fn benchmarks() -> Vec<(&'static str, Benchmark)> {
    ...
    add_benchmarks(
        &mut benchmarks,
        &[
            ("basic", counter::basic::basic),
            ("ilp1", counter::ilp::ilp::<1>),
            ("ilp14", counter::ilp::ilp::<14>),
            ("ilp15", counter::ilp::ilp::<15>),
            ("ilp16", counter::ilp::ilp::<16>),
            ("ilp16", counter::simd::basic::simd_basic),
            (
                "generic_ilp1_u64",
                counter::simd::ilp::generic_ilp_u64::<1, u64>,
            ),
            (
                "generic_ilp15_u64",
                counter::simd::ilp::generic_ilp_u64::<15, u64>,
            ),
            (
                "multiversion_sse2",
                counter::simd::multiversion::multiversion_sse2,
            ),
            (
                "multiversion_avx2",
                counter::simd::multiversion::multiversion_avx2,
            ),
        ],
    );
    #[cfg(target_feature = "sse2")]
    {
        ...
        add_benchmarks(
            &mut benchmarks,
            &[
                ("simd_basic", counter::simd::basic::simd_basic),
                ("simd_ilp1", counter::simd::ilp::simd_ilp::<1>),
                ("simd_ilp7", counter::simd::ilp::simd_ilp::<7>),
                ("simd_ilp8", counter::simd::ilp::simd_ilp::<8>),
                ("simd_ilp9", counter::simd::ilp::simd_ilp::<9>),
                (
                    "generic_ilp1_u64x2",
                    counter::simd::ilp::generic_ilp_u64::<1, m128i>,
                ),
                (
                    "generic_ilp9_u64x2",
                    counter::simd::ilp::generic_ilp_u64::<9, m128i>,
                ),
                (
                    "extreme_ilp_1p1x1",
                    counter::simd::ilp::extreme_ilp::<1, 1, 1, 2>,
                ),
                (
                    "extreme_ilp_2p1x1",
                    counter::simd::ilp::extreme_ilp::<2, 1, 1, 2>,
                ),
                (
                    "extreme_ilp_3p1x1",
                    counter::simd::ilp::extreme_ilp::<3, 1, 1, 2>,
                ),
                (
                    "extreme_ilp_1p2x1",
                    counter::simd::ilp::extreme_ilp::<1, 2, 1, 2>,
                ),
                (
                    "extreme_ilp_3p2x2",
                    counter::simd::ilp::extreme_ilp::<3, 2, 2, 2>,
                ),
                (
                    "extreme_ilp_3p2x3",
                    counter::simd::ilp::extreme_ilp::<3, 2, 3, 2>,
                ),
                (
                    "extreme_ilp_3p2x4",
                    counter::simd::ilp::extreme_ilp::<3, 2, 4, 2>,
                ),
                (
                    "extreme_ilp_3p2x5",
                    counter::simd::ilp::extreme_ilp::<3, 2, 5, 2>,
                ),
            ],
        );
    }
    #[cfg(target_feature = "avx2")]
    {
        ...
        add_benchmarks(
            ...
            &[
                (
                    "narrow_simple_u32",
                    counter::simd::narrow::narrow_simple::<u32>,
                ),
                (
                    "narrow_simple_u16",
                    counter::simd::narrow::narrow_simple::<u16>,
                ),
                (
                    "narrow_simple_u8",
                    counter::simd::narrow::narrow_simple::<u8>,
                ),
                ("narrow_u8", counter::simd::narrow::narrow_u8),
                ("narrow_u8_tuned", counter::simd::narrow::narrow_u8_tuned),
            ],
        );
        benchmarks.push((
            "thread_basic",
            Benchmark::Parallel(Box::new(|| {
                Box::new(|target| {
                    counter::thread::basic::thread_basic(
                        target,
        ...
        benchmarks.push((
            ...
            Benchmark::Parallel(Box::new(|| {
                Box::new(|target| {
                    counter::thread::rayon::thread_rayon(
                        target,
                        counter::simd::narrow::narrow_u8_tuned,
                    )
                }) as CounterBox
